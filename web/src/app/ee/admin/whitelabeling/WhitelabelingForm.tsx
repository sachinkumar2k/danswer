          ...
          <Form>
            <div className="my-6">
              <EditingValue
                ...
                description={`The custom name you are giving Danswer for your organization. This will replace 'Danswer' everywhere in the UI.`}
            ...
            <div className="mt-6">
              <EditingValue
                ...
                description={`Custom Markdown content that will be displayed as a banner at the top of the Chat page.`}
            ...
            <div className="mt-6">
              <EditingValue
                ...
                description={`The title for the popup that will be displayed for each user on their initial visit to the application. If left blank AND Custom Popup Content is specified, will use "Welcome to ${values.application_name || "Danswer"
                  }!".`}
            ...
            <div className="mt-6">
              <EditingValue
                ...
                description={`Custom Markdown content that will be displayed as a popup on initial visit to the application.`}
